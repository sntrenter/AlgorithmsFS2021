...
//
//Due to file Read write problems on clark, classes are defined here. 
//
...
int main(int argc, char *argv[])
{
    ...
    cout << "Start\n";
    string filename = "examples/ex1_3child_20gifts.txt";
    //filename = "optimized_examples/ex1_3child_20gifts.txt";
